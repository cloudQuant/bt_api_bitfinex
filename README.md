...
This package provides **Bitfinex exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BITFINEX** exchange.
...
```
bt_api_bitfinex/
├── src/bt_api_bitfinex/     # Source code
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_bitfinex/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **Bitfinex exchange plugin for bt_api**。它提供了与 **BITFINEX** 交易所交互的统一接口。
...
| GitHub 仓库 | https://github.com/cloudQuant/bt_api_bitfinex |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_bitfinex/issues) 反馈问题
